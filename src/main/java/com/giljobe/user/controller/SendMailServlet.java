...
public class SendMailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		User user = UserService.userService().searchUserByIdAndEmail(userId,userEmail);
		if (user == null) {
			 out.print("fail");
			    out.close();
			    return;
			...
			request.getSession().setAttribute("authenticNum", number);
			request.getSession().setAttribute("authenticUserId", userId);
